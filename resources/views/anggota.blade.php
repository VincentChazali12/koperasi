                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form action="{{route('anggota2.store')}}" role="form" method="POST">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                          <div class="form-group col-6">
                            ...
                            <input type="text" class="form-control ttl" name="tempat" id="ttl" placeholder="Masukkan Tempat Lahir">
                            <input type="date" class="form-control ttl" name="tanggallahir" id="ttl" placeholder="Masukkan Tanggal Lahir">
                          </div>
                          <div class="form-group col-6">
