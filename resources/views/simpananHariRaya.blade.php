             ...
             <div class="card-body">
                  ...
                  <div class="modal-dialog modal-lg" >
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action="{{route('hariraya.store')}}" role="form" method="POST">
                          @csrf
                          <div class="row">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    @endif
                    <td>{{$data->status}}</td>
                    <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('detailHariRaya.store') }}" role="form" method="POST">
                    @csrf
                      ...
                      <td><a href="{{ route('hariraya.show', $data->idq) }}">Detail</a> | <input type="submit" class="btn" value="Tambah" style="padding:0px;">
                    </form>
                  </tr>
